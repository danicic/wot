...
- Creating compositions of resources from multiple devices in form of TD Recipes, where the compositions are based on reusable syntactic and semantic modules.
